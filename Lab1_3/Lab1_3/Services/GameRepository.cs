...
public class GameDto
{
    ...
    public RequirementsDto Requirements { get; set; } = new();
...
public class GameRepository
{
    ...
    public bool AddGame(Game game)
    {
        ...
        if (_games.Any(g => g.Name.Equals(game.Name, StringComparison.OrdinalIgnoreCase))) return false;
    ...
    public bool UpdateGame(Game updatedGame)
    {
        var existingGameIndex =
            _games.FindIndex(g => g.Name.Equals(updatedGame.Name, StringComparison.OrdinalIgnoreCase));
        if (existingGameIndex == -1) return false;
    ...
    private void SaveGames()
    {
        try
        {
            ...
            var jsonText = JsonSerializer.Serialize(gameData, new JsonSerializerOptions
            {
                WriteIndented = true
            });
...
public class GameData
{
    ...
    public RequirementsData Requirements { get; set; } = new();
    public bool IsOnline { get; set; }
}
